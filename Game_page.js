...
document.getElementBydI("player_question").innerHTML="question turn- "+player1_name;
document.getElementBydI("player_answer").innerHTML="question turn- "+player2_name;
function send() {
